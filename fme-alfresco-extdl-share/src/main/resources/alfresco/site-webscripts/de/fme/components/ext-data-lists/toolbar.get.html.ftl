<@markup id="css" >
   ...
   <@link href="${url.context}/res/components/data-lists/extended-toolbar.css"  group="datalists"/>
</@>

<@markup id="js">
   <#-- JavaScript Dependencies -->
   <@script type="text/javascript" src="${url.context}/res/components/data-lists/toolbar.js"            group="datalists"/>
   <@script type="text/javascript" src="${url.context}/res/components/data-lists/extended-toolbar.js"   group="datalists"/>
</@>
